    ...
    <div class="row " style="margin-top: 20px;margin-left: 10px" >
        <form class="form-inline " style="height: 30px;" id="biao1" >
            <div class="form-group col-md-1" style="margin-right: 10px">
                <button type="button" class="btn btn-default" onclick="typeadd()"><i class="glyphicon glyphicon-plus"></i>添加仓库</button>
            </div>
            <div class="form-group col-md-1" style="margin-right: 10px">
...
<script>
    var eve={
        'click .ev':function (e,value,row,index) {
            ...
            $("#typeupdate input[name=whName]").val(row.shoptypeName);
        }}
    function de() {
    ...
    function type(){
        $("#typeadd").dialog({
            ...
            btnName:"添加",
            btnBind:function(){
                var whName=$("#typeadd").serialize();
                $.post(ctx+"wh/add",whName,function(msg){
                    toastr.warning(msg);
        ...
        $("#typeupdate").dialog({
            ...
            btnName:"修改",
            btnBind:function(){
                var whName=$("#typeupdate").serialize();
                $.post(ctx+"wh/update",whName,function(msg){
                    toastr.warning(msg);
                    $("#table").bootstrapTable("refresh");
